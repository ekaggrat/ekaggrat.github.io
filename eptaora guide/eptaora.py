...
PAGE_MARGIN = '20vw'  # <--- Change this to adjust your side margins (e.g., '100px', '5%', '15vw')
...
<body class="bg-white text-black overflow-x-hidden">
    ...
    <div class="w-full mx-auto pt-32 pb-20" style="padding-left: [PAGE_MARGIN]; padding-right: [PAGE_MARGIN];">
...
ITEM_TEMPLATE = """
            <div class="group block cursor-pointer w-full" onclick="openModal([INDEX])">
...
YOUTUBE_TEMPLATE = """
            <div class="w-full aspect-video bg-gray-50 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center p-6 text-center my-4">
                ...
                <span class="text-sm font-bold tracking-widest uppercase text-gray-500">YouTube Embed</span>
                <span class="text-xs text-gray-400 mt-2">Replace this div with your iframe</span>
            </div>
"""
...
def generate_gallery():
    ...
    # Inject the variable margin
    header_html = header_html.replace("[PAGE_MARGIN]", PAGE_MARGIN)
    ...
    print(f"Success! Generated '{output_file}' with {len(files)} images. Page margin set to {PAGE_MARGIN}.")
